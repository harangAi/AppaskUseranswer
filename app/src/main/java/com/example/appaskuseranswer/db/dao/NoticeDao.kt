package com.example.appaskuseranswer.db.dao
...
interface NoticeDao{
    ...
    suspend fun getOneNotice(id: Int) : Notice?
    ...
    suspend fun insert(notice: Notice): Int //Int를 return하면 해당 notice의 id를 알 수 있다.
